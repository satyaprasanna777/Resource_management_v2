...
class ResourceModel {
    ...
    setGetItemsListAPIStatus(status) {
        ...
        console.log("ststussssssssssss....", this.getItemsListAPIStatus)
    }

    @action.bound
    setGetItemsListAPIError(error) {
        this.getItemsListAPIError = error;
        console.log(error, "errrrrrrooooooooooorrrrrrrrrrrrr");
    }

    @action.bound
    setItemsListResponse(response) {
        this.itemsList = response.items.map(eachItem => new ItemModel(eachItem));
        console.log(this.itemsList, "itemslisttttttttttttttttttttttttttttttttttt");
    ...
    setAddItemAPIResponse(response) {
        console.log("add item response is set successfully");
    }

    @action.bound
    deleteItemsFromItemsList(list) {
        const apiObject = { "item_ids_list": list };
        const deleteItemsService = this.itemsService.deleteItemsAPI(apiObject);
